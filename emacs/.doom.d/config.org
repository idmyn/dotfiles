...
(use-package! neuron-mode
  :custom
  (neuron-default-zettelkasten-directory (expand-file-name "~/Dropbox/zettelkasten"))
  :custom-face
  (neuron-title-overlay-face ((t (:foreground "black" :underline t)))))
#+END_SRC
** JavaScript

...
(use-package! zetteldeft
  ...
  (map!
   ...
   :desc "Search for a note" "s" 'deft-find-file
...
#+END_SRC
** Markdown & Org
set the =grip-binary-path= for [[https://github.com/seagle0128/grip-mode][grip-mode]]
#+BEGIN_SRC emacs-lisp
(setq grip-binary-path "~/.pyenv/shims/grip")
#+END_SRC
** Common Lisp
#+BEGIN_SRC emacs-lisp
(map!
